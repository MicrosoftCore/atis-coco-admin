export default {
   ...
   * @augments { selection/index/expand }
   * @type <string>
   */
  type: undefined,
   ...
   * @augments { 数组中的元素需为以下三者之一：ascending 表示升序，descending 表示降序，null 表示还原为原始顺序 }
   * @type <array>
   */
  ...
  /**
   * @param filter-placement
   * @description 过滤弹出框的定位
   * @augments { 与 Tooltip 的 placement 属性相同 }
   * @type <String>
   */
  filterPlacement: undefined,

  /**
   * @param filter-multiple
