...
export default {
  ...
  methods: {
    ...
    onSubmit () {
      ...
      let addData = Object.assign({}, data, { CreateBy: UserID })
      let updateData = Object.assign({}, data, { Id, UpdateBy: UserID })

      let url = Id ? updateUrl : addUrl
      let message = Id ? updateMsg : addMeg
